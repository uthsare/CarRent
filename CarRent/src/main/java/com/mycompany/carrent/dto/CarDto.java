...
public class CarDto {
   private String category;
    ...
    public CarDto(String category,String brand, String model, String mfyear, String regNo, int NoOfCars) {
    ...
    public String toString() {
        return "CarDto{" + "category=" + category + ", brand=" + brand + ", model=" + model + ", mfyear=" + mfyear + ", regNo=" + regNo + ", NoOfCars=" + NoOfCars + '}';
    }
