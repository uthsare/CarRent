...
public class RentEntity {
    ...
    public RentEntity(String rentId,String brand, String model, String mfyear, String regNo, int rentalPeriod) {
        this.rentId=rentId;
        this.brand = brand;
        this.model = model;
        this.mfyear = mfyear;
 ...
 /**
    ...
    public String toString() {
        return "RentEntity{" + "rentId=" + rentId + ", brand=" + brand + ", model=" + model + ", mfyear=" + mfyear + ", regNo=" + regNo + ", rentalPeriod=" + rentalPeriod + '}';
    }
