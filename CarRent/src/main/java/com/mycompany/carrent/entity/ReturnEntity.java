...
private String damages;
    ...
    public ReturnEntity(String brand, String model, String mfyear, String regNo, String damages) {
        this.brand = brand;
        this.model = model;
        this.mfyear = mfyear;
        this.regNo = regNo;
    ...
    public String toString() {
        return "ReturnEntity{" + "brand=" + brand + ", model=" + model + ", mfyear=" + mfyear + ", regNo=" + regNo + ", damages=" + damages + '}';
    }
